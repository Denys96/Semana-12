...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        try {
            ...
            menu.setHeaderTitle(datosJSON.getJSONObject(info.position).getJSONObject("value").getString("nonbre").toString());
    ...
    private class obtenerDatos extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                ListView lstAgenda = (ListView) findViewById(R.id.ltsAmigos);

                final ArrayList<String> alAgenda = new ArrayList<String>();
                final ArrayAdapter<String> aaAgenda = new ArrayAdapter<String>(MainActivity.this,
        ...
        @Override
            ...
            try {
                ...
                if(jsonObject.getBoolean("ok")){
                    ...
                    Toast.makeText(MainActivity.this, "Error al intentar guardar el registro...", Toast.LENGTH_LONG).show();
                }
            }catch (Exception ex){
